// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["dyttzy","ruyi","bfzy","tyyszy","xiaomaomi","ffzy","heimuer","zy360","wolong","jisu","dbzy","mozhua","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun","lzi"]'); // 默认选中资源
